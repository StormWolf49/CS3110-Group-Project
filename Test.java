...
public class Test {
    ...
    //Test method that runs all 4 required FAs, as well as the example FA that was provided which was used in intial testing of program.
    ...
    public static void setup(Scanner data) {
        ...
        //Tests the test strings given and outputs them along with wether they're accepted by the FA.
